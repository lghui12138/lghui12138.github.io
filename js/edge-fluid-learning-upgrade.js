...
(function(global, document) {
  ...
  var ROADMAP100_VERSION = 'round414-progress-snapshot-181103-video-release-20260620';
  ...
  var DISCOVERY_LINKS = [
    ...
    },
    {
      ...
      url: '/modules/real-exams-dynamic.html?edge_refresh=round414-progress-snapshot-181103-video-release-20260620&from=round342-edge-search'
    },
    {
      id: 'round342-formula',
      type: '入口',
  ...
  function renderRound274WorkbenchLoop(summary) {
    ...
    return '<div class="eflu-review-rail" data-round274-workbench-loop="round414-progress-snapshot-181103-video-release-20260620" aria-label="round274 老师复习顺序">' + steps.map(function(step) {
