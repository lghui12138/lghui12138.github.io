...
(function(global, document) {
  ...
  var ROADMAP100_VERSION = 'round376-181103-visible-522-all-question-proof-20260617';
  ...
  var DISCOVERY_LINKS = [
    ...
    },
    {
      ...
      url: '/modules/real-exams-dynamic.html?edge_refresh=round376-181103-visible-522-all-question-proof-20260617&from=round342-edge-search'
    },
    {
      id: 'round342-formula',
      type: '入口',
  ...
  function renderRound274WorkbenchLoop(summary) {
    ...
    return '<div class="eflu-review-rail" data-round274-workbench-loop="round376-181103-visible-522-all-question-proof-20260617" aria-label="round274 老师复习顺序">' + steps.map(function(step) {
