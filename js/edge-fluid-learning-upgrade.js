...
(function(global, document) {
  ...
  var VERSION = 'round584-question-bank-home-density-20260630-eflu-workbench';
  ...
  var ROADMAP100_VERSION = 'round584-question-bank-home-density-20260630';
  ...
  var DISCOVERY_LINKS = [
    {
      ...
      url: '/modules/question-bank.html?focus=181103-material-extracted&answer_status=current&edge_refresh=round584-question-bank-home-density-20260630#questionBanksList'
    },
    {
      ...
      url: '/modules/real-exams-dynamic.html?edge_refresh=round584-question-bank-home-density-20260630&from=round342-edge-search'
    },
    {
      id: 'round342-formula',
      type: '入口',
  ...
  function chapterRealExamUrl(chapter) {
    return '/modules/real-exams-dynamic.html?edge_refresh=round584-question-bank-home-density-20260630&chapter=' + encodeURIComponent(chapter) + '&from=edge-learning-workbench';
  }
    ...
    if (chapters.length) {
      var chapterPaths = chapters.map(function(chapter, index) {
        ...
        return {
          ...
          tone: index % 3 === 0 ? 'teal' : (index % 3 === 1 ? 'coral' : 'indigo'),
          practiceUrl: chapterNo ? '/modules/practice-dynamic.html?type=real&chapter=' + encodeURIComponent(chapterNo) + '&mode=normal&from=edge-learning-path' : '/modules/real-exams-dynamic.html?edge_refresh=round584-question-bank-home-density-20260630&from=edge-learning-path',
          realExamUrl: chapterNo ? chapterRealExamUrl(chapterNo) : '/modules/real-exams-dynamic.html?edge_refresh=round584-question-bank-home-density-20260630&from=edge-learning-path',
  ...
  function renderHero(summary) {
    ...
    return [
      ...
      '<a class="eflu-btn" data-tone="coral" href="/modules/real-exams-dynamic.html?edge_refresh=round584-question-bank-home-density-20260630&from=student-workbench-practice" aria-label="进入历年真题和题库练习">' + icon('play') + '真题练习</a>',
      ...
      '<a class="eflu-btn" data-round342-discovery-entry="181103" href="/modules/question-bank.html?focus=181103-material-extracted&answer_status=current&edge_refresh=round584-question-bank-home-density-20260630#questionBanksList" aria-label="进入 181103 资料题库，查看 522 张来源卡、400 道默认练习、400 道可直接参考答案、0 道待人工源页复核、122 条源文线索和 38 份 HTML 资料">' + icon('external') + '181103 资料</a>',
  ...
  function renderRound277FormulaConditionSprint() {
    ...
    return [
      ...
      '<a class="eflu-btn" href="/modules/real-exams-dynamic.html?edge_refresh=round584-question-bank-home-density-20260630&from=round277-formula-condition-sprint">' + icon('play') + '真题重做</a>',
      '</div>',
      '</section>'
    ].join('');
  }
  ...
  function renderRound278PdfWebYearCompare() {
    ...
    if (!compare) {
      return [
        ...
        '<a class="eflu-btn" href="/modules/real-exams-dynamic.html?edge_refresh=round584-question-bank-home-density-20260630&from=round278-pdf-web-year-compare">' + icon('external') + '真题训练</a>',
        '</div>',
        '</section>'
      ].join('');
    }
  ...
  function renderExamRouteDetail(route) {
    ...
    return [
      ...
      '<a class="eflu-btn" href="/modules/real-exams-dynamic.html?edge_refresh=round584-question-bank-home-density-20260630&from=exam-route" aria-label="打开历年真题训练">' + icon('external') + '去真题训练</a>',
      '</div>',
      '</article>',
      '</div>'
    ].join('');
