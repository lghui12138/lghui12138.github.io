...
(function(global, document) {
  ...
  var ROADMAP100_VERSION = 'round357-181103-auth-workflow-proof-20260615';
  ...
  var DISCOVERY_LINKS = [
    ...
    },
    {
      ...
      url: '/modules/real-exams-dynamic.html?edge_refresh=round357-181103-auth-workflow-proof-20260615&from=round342-edge-search'
    },
    {
      id: 'round342-formula',
      type: '入口',
  ...
  function renderRound274WorkbenchLoop(summary) {
    ...
    return '<div class="eflu-review-rail" data-round274-workbench-loop="round357-181103-auth-workflow-proof-20260615" aria-label="round274 老师复习顺序">' + steps.map(function(step) {
