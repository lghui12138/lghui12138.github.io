    ...
    const cards=[
      {
        ...
        href:path.doneCount>=path.total?'/modules/real-exams-dynamic.html?edge_refresh=round585-real-exam-workbench-density-20260630&from=round273-radar-complete':(next.p||'/modules/real-exams-dynamic.html?edge_refresh=round585-real-exam-workbench-density-20260630&from=round273-radar'),
