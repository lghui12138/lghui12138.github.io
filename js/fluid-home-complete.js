    ...
    const cards=[
      {
        ...
        href:path.doneCount>=path.total?'/modules/real-exams-dynamic.html?edge_refresh=round587-resource-hub-reader-density-20260630&from=round273-radar-complete':(next.p||'/modules/real-exams-dynamic.html?edge_refresh=round587-resource-hub-reader-density-20260630&from=round273-radar'),
