    ...
    const cards=[
      {
        ...
        href:path.doneCount>=path.total?'/modules/real-exams-dynamic.html?edge_refresh=round586-practice-answer-workbench-20260630&from=round273-radar-complete':(next.p||'/modules/real-exams-dynamic.html?edge_refresh=round586-practice-answer-workbench-20260630&from=round273-radar'),
