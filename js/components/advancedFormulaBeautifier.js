...
class AdvancedFormulaBeautifier {
     ...
     */
    loadMathJax() {
        if (window.FMLoadMathJax) {
            window.FMLoadMathJax();
            return;
        }
        this.configureMathJax();
        ...
        mathJaxScript.src = '/vendor/mathjax/es5/tex-chtml-full.js';
    ...
    configureMathJax() {
        ...
        window.MathJax = {
            ...
            chtml: {
                fontURL: '/vendor/mathjax/es5/output/chtml/fonts/woff-v2'
            },
            options: {
     ...
     */
    typeset() {
        if (window.FMTypesetMath) {
            window.FMTypesetMath(document.body);
