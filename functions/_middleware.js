...
const EDGE_HOME_VERSION = 'round577-181103-proof-depth-second-pass-20260629';
const EDGE_RUNTIME_JS_VERSION = 'round577-181103-proof-depth-second-pass-20260629';
...
<body>
  ...
  <script src="/js/core/local-mathjax.js?v=round577-181103-proof-depth-second-pass-20260629"></script><script>const fmIdle=window.requestIdleCallback||((fn,opts)=>setTimeout(fn,opts&&opts.timeout||320));fmIdle(()=>window.FMQueueMath?.(document.querySelector(".ns-fast"),520),{timeout:650});</script>
