...
const EDGE_HOME_VERSION = 'round583-question-bank-interaction-a11y-20260630';
const EDGE_RUNTIME_JS_VERSION = 'round583-question-bank-interaction-a11y-20260630';
      ...
      <div>
        ...
        <div class="upgrade-note" aria-label="当前入口可见升级">
          ...
          <div class="upgrade-links" aria-label="公式回查入口预览">
            ...
            <a href="/modules/question-bank.html?focus=181103-material-extracted&answer_status=current&edge_refresh=round583-question-bank-interaction-a11y-20260630#questionBanksList">181103 资料题库</a>
            <a href="/modules/real-exams-dynamic.html?edge_refresh=round583-question-bank-interaction-a11y-20260630">真题训练</a>
...
<body>
    ...
    <main>
      <section class="hero">
        <div class="lead">
          <div>
            ...
            <div class="upgrade-actions">
              ...
              <a href="/modules/question-bank.html?focus=181103-material-extracted&answer_status=current&edge_refresh=round583-question-bank-interaction-a11y-20260630#questionBanksList" data-round356-home-181103-icon="fast-home-bank"><b>181103 资料题库</b><span>522 来源卡 / 400 练习 / 400+0 答案 / 122 线索，不混历年真题</span></a>
              ...
              <a href="/modules/real-exams-dynamic.html?edge_refresh=round583-question-bank-interaction-a11y-20260630"><b>真题训练</b><span>325 道原文原子题，68 个组题 section 已拆开</span></a>
        ...
        <aside class="panel" role="search" aria-label="快速入口搜索"><label class="sr-only" for="s">搜索首页入口</label><input id="s" class="search" autocomplete="off" placeholder="搜索入口" aria-controls="quick" aria-describedby="fastSearchStatus"><span id="fastSearchStatus" class="sr-only" aria-live="polite" aria-atomic="true">显示全部入口</span><div id="quick" class="quick" aria-label="快速入口">
          ...
          <a class="q featured" href="/modules/question-bank.html?focus=181103-material-extracted&answer_status=current&edge_refresh=round583-question-bank-interaction-a11y-20260630#questionBanksList" data-k="${EDGE_HOME_VERSION} 181103 资料题库 522 来源卡 400 练习 400 可参考 0 待复核 122 线索 OCR 资料内题目 不混真题"><span class="ic">522</span><span><b>181103 资料题库</b><span>522 来源卡 / 400 练习 / 400+0 答案 / 122 线索</span></span><span class="arr">›</span></a>
          ...
          <a class="q featured" href="/modules/real-exams-dynamic.html?edge_refresh=round583-question-bank-interaction-a11y-20260630" data-k="${EDGE_HOME_VERSION} 题库 真题训练 原文小问拆分 325题 68组题 217小问 已核验 练习 考研 2000 2024 错题复盘"><span class="ic">题</span><span><b>真题训练</b><span>325 道原文原子题，68 个组题 section 已拆开</span></span><span class="arr">›</span></a>
	      ...
	      <section class="upgrade-strip" aria-label="公式条件回查路线"><a class="upgrade-card primary" href="/resources/fluid-181103-html/index.html" data-round356-home-181103-icon="fast-home-strip"><small>181103</small><b>资料库</b><em>38 份资料全量 HTML 化，站内看正文、图页和资料题来源。</em></a><a class="upgrade-card" href="/modules/question-bank.html?focus=181103-material-extracted&answer_status=current&edge_refresh=round583-question-bank-interaction-a11y-20260630#questionBanksList"><small>400+0</small><b>资料题库</b><em>400 练习、400 可参考、0 待复核和 122 线索，与历年真题和原卷答案边界分开。</em></a><a class="upgrade-card" href="/modules/knowledge-upgrade-2026.html"><small>条件表</small><b>公式回查表</b><em>适用条件、边界条件、单位方向和错因按顺序查。</em></a><a class="upgrade-card" href="/ultimate-beautiful-formulas.html"><small>公式回查</small><b>逐条核条件</b><em>连续、伯努利、动量、量纲和黏性近似先问能不能用。</em></a><a class="upgrade-card" href="/resources/fluid-original-animations.html"><small>动画</small><b>看清边界方向</b><em>卡在控制体、边界层或管路图时，先看自制动画。</em></a><a class="upgrade-card" href="/modules/site-updates.html"><small>更新</small><b>最近修复</b><em>公式渲染、入口和资料索引的公开更新记录。</em></a>${accountRecordCard}</section>
  ...
  <script src="/js/core/local-mathjax.js?v=round583-question-bank-interaction-a11y-20260630"></script><script>const fmIdle=window.requestIdleCallback||((fn,opts)=>setTimeout(fn,opts&&opts.timeout||320));fmIdle(()=>window.FMQueueMath?.(document.querySelector(".ns-fast"),520),{timeout:650});</script>
