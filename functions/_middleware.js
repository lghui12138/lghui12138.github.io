...
const EDGE_HOME_VERSION = 'round581-question-bank-card-polish-20260630';
const EDGE_RUNTIME_JS_VERSION = 'round581-question-bank-card-polish-20260630';
...
<body>
  ...
  <script src="/js/core/local-mathjax.js?v=round581-question-bank-card-polish-20260630"></script><script>const fmIdle=window.requestIdleCallback||((fn,opts)=>setTimeout(fn,opts&&opts.timeout||320));fmIdle(()=>window.FMQueueMath?.(document.querySelector(".ns-fast"),520),{timeout:650});</script>
