...
const EDGE_HOME_VERSION = 'round579-real-exam-answer-depth-twelfth-pass-20260629';
const EDGE_RUNTIME_JS_VERSION = 'round579-real-exam-answer-depth-twelfth-pass-20260629';
...
<body>
  ...
  <script src="/js/core/local-mathjax.js?v=round579-real-exam-answer-depth-twelfth-pass-20260629"></script><script>const fmIdle=window.requestIdleCallback||((fn,opts)=>setTimeout(fn,opts&&opts.timeout||320));fmIdle(()=>window.FMQueueMath?.(document.querySelector(".ns-fast"),520),{timeout:650});</script>
